...
const Applications = ({ match }) => (
  <div className="dashboard-wrapper">
    <Switch>
      ...
      <Route path={`${match.url}/riwayat/:id`} component={profileUkm} />            
      <Route path={`${match.url}/aktif`} exact component={aktif} />
      <Route path={`${match.url}/aktif/:id`} component={profileUkm} />            
      <Route path={`${match.url}/diterima`} exact component={diterima} />
      <Route path={`${match.url}/diterima/:id`} component={profileUkm} />            
      <Route path={`${match.url}/ditolak`} exact component={ditolak} />
      <Route path={`${match.url}/ditolak/:id`} component={profileUkm} />            
