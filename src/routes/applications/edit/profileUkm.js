...
import { getUkmProfile , postPendaftaranUkm , clearFormPendaftaran} from "Redux/actions";
...
componentDidUpdate(){
  ...
  render() {
    ...
    return (
      ...
      <Link to="/app/applications/riwayat">  
...
const mapStateToProps = ({ ukmReducer , pendaftaranReducer }) => {
    const { id_ukm, nama_ukm, deskripsi_ukm , is_oprec} = ukmReducer;
    const { pen } = pendaftaranReducer
    return { id_ukm, nama_ukm, deskripsi_ukm, is_oprec , pen};
  };
